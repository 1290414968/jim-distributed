 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8080/w/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://webservice/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/w/hello?wsdl");
    ...
    public HelloImpl getHelloImplPort() {
        return super.getPort(new QName("http://webservice/", "HelloImplPort"), HelloImpl.class);
    }
    ...
    public HelloImpl getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "HelloImplPort"), HelloImpl.class, features);
    }
